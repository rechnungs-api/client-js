...
import type { ListDocumentsData, ListDocumentsResponse, CreateDocumentData, CreateDocumentResponse, ReadDocumentData, ReadDocumentResponse, ListLedgersData, ListLedgersResponse, CreateLedgerData, CreateLedgerResponse, DeleteLedgerData, DeleteLedgerResponse, ListLedgerAccountsData, ListLedgerAccountsResponse, CreateLedgerAccountData, CreateLedgerAccountResponse, ListLedgerTransactionsData, ListLedgerTransactionsResponse, CreateLedgerTransactionData, CreateLedgerTransactionResponse, ArchiveLedgerTransactionData, ArchiveLedgerTransactionResponse, ListLedgerBalancesData, ListLedgerBalancesResponse } from './types.gen';
...
/**
 * List documents
 * Lists all documents previously created by the document creation endpoint that have not yet expired. The information returned per document is only partial, use the `readDocument` endpoint to retrieve the full document metadata, PDF or XML.
 */
export const listDocuments = <ThrowOnError extends boolean = false>(options: Options<ListDocumentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListDocumentsResponse, unknown, ThrowOnError>({
 ...
 */
export const archiveLedgerTransaction = <ThrowOnError extends boolean = false>(options: Options<ArchiveLedgerTransactionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ArchiveLedgerTransactionResponse, unknown, ThrowOnError>({
